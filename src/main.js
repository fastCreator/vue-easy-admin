...
;(async () => {
  ...
  const { init, userManage, userManage: { getUserInfo, getPermission, whitePermission } } = importAllVue('./main.js')
  ...
  store.commit('setPermission', whitePermission.concat(await getPermission(request))) // 设置用户权限
